...
import 'package:archive/screens/members_document_archive/members_document_archive.dart';
import 'package:archive/ui/theme/archive_primary_theme.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

class BuildMembersHomeMenu extends StatelessWidget {
  const BuildMembersHomeMenu({Key? key}) : super(key: key);
        ...
        _buildButtonMenu(
            onTap: () {
              Navigator.push(
                context,
                CupertinoPageRoute(
                  builder: (c) => const MembersDocumentArchiveScreen(),
                ),
              );
            },
